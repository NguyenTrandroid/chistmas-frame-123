...
import bo.photo.module.util.IOUtil;
import bo.photo.module.util.MD5Util;
import bo.photo.module.util.StringUtils;
...
public class FileUtils {
    ...
    public File getExtFile(Context context,String path) {
        return new File(SupportUtils.getRootDirPath(context) + path);
    }
    ...
    public boolean copyAssetFileToFiles(Context context, String filename) {
        return copyAssetFileToFiles(context, filename, getExtFile(context,"/" + filename));
    }

    private boolean copyAssetFileToFiles(Context context, String filename, File of) {
        InputStream is = null;
        FileOutputStream os = null;
        Log.d("testfile",of.getAbsolutePath());
        Log.d("testfile",filename);
        try {
