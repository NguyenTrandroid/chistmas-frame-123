...
public class FragmentAddPhoto2 extends Fragment {
    FragmentManager fragmentManager;
    FragmentTransaction fragmentTransaction;
    FragmentGalleryPhoto2 fragmentGalleryPhoto2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fragmentGalleryPhoto2 = new FragmentGalleryPhoto2();
        bundle = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        opengallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                fragmentManager.popBackStack();
                fragmentGalleryPhoto2.setArguments(bundle);
                fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.rl_main,fragmentGalleryPhoto2).addToBackStack("galleryphoto");
                try {
