...
public class TextSticker extends Sticker {
  ...
  @NonNull public TextSticker setTypeface(@Nullable Typeface typeface,boolean bold,boolean italic,boolean underline) {
    textPaint.setTypeface(typeface);
    if(bold){
      if(italic){
        textPaint.setTypeface(Typeface.create(typeface,Typeface.BOLD_ITALIC));
      }else textPaint.setTypeface(Typeface.create(typeface,Typeface.BOLD));
    }else {
      if(italic) {
        textPaint.setTypeface(Typeface.create(typeface, Typeface.ITALIC));
      }
    }
    if(underline)setTextFlag(Paint.UNDERLINE_TEXT_FLAG);
    return this;
  }
//  @NonNull public TextSticker setType(Typeface typeface,boolean bold,boolean italic,boolean underline) {
//    if(bold){
//      if(italic){
//        textPaint.setTypeface(Typeface.create(typeface,Typeface.BOLD_ITALIC));
//      }else textPaint.setTypeface(Typeface.create(typeface,Typeface.BOLD));
...
//  }
  ...
  @NonNull public TextSticker setTextColor(@ColorInt int color) {
    ...
    @NonNull public TextSticker setTextFlag(@ColorInt int flag) {
        textPaint.setFlags(flag);
        return this;
    }
