package stickertest.com.firebase.bimbim.collagedemo.template;
...
import stickertest.com.firebase.bimbim.collagedemo.model.ImageTemplate;
...
//        changeItem.setSticky(true);
    ...
    private void asyncCreateBackgroundImage(final String path) {
        Log.d(TAG, "asyncCreateBackgroundImage");
    ...
    private ItemImageView addPhotoItemView(PhotoItem item, float internalScale, float outputScaleRatio) {
        ...
        Log.d("PhotoLayout", "addPhotoItemView, item.x=" + item.x + ", item.y=" + item.y + ", scale=" + internalScale);
    ...
    public void recycleImages(final boolean recycleBackground) {
        Log.d(TAG, "recycleImages, recycleBackground=" + recycleBackground);
